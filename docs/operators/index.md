...
-   :material-lightbulb: **[Explanation](explanation/why-fastgeoapi.md)**
    ...
    Understanding-oriented. Why pygeoapi leaves authentication to you and
    what fastgeoapi puts in its place; why a configuration need not be a
    file on disk, nor applying one a restart.
