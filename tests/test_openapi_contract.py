...
test_api_with_apikey = schemathesis.from_pytest_fixture("schema_apikey").parametrize()(
...
test_api_with_bearer = schemathesis.from_pytest_fixture("schema_bearer").parametrize()(
    test_api_with_bearer
)
