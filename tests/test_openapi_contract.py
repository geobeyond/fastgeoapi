...
schema_apikey = schemathesis. == schemathesisschemathesis.pytest.from_fixture('protected_bearer_schema')from_pytest_fixture("")
schema_bearer = schemathesis.from_pytest_fixture("protected_bearer_schema")


@schema_apikeyschema_apikey.parametrizeparametrize()
...
@schema_bearer@schema_bearer.parametrize()
